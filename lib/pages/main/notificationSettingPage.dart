...
class _NotificationSettingsPageState extends State<NotificationSettingsPage> {
          ...
          children: [
            ...
            CupertinoButton(
              ...
              onPressed: () {
                ...
                if (_firstTime != null) {
                  _scheduleNotification(_firstTime!, id: 0, title: 'First Notification');
                  _scheduleNotification(_secondTime!, id: 1, title: 'Second Notification');
                }
              },
            )
          ],
  ...
  Future<void> _scheduleNotification(TimeOfDay time,
    ...
    final tz.TZDateTime finalSchedule = scheduledDate.isBefore(tz.TZDateTime.now(tz.local))
                    ...
                    child: Column(
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: _buildTimeDisplay("First Time Received", _firstTime),
                        ),
                        const SizedBox(height: 20),
                        ...
                        CupertinoButton.filled(
                          onPressed: _allNotificationsEnabled ? _sendTestNotification : null,
